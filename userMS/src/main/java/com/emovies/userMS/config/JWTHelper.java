...
public class JWTHelper {
	...
	public String generateToken(UserDetails userDetails, UserInfo portfolioUser) {
		Map<String, UserInfo> claims = new HashMap<>();

		claims.put("userData", portfolioUser);
	...
	private String doGenerateToken(Map<String, UserInfo> claims, String subject) {
